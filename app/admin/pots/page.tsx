...
export default function PotsAdminPage() {
  ...
  return <main className="authenticated-page"><AuthenticatedHeader user={user} /><div className="admin-shell">
    <div className="admin-title"><div><p className="eyebrow">ORGANIZAÇÃO DA CASA</p><h1>Potes</h1><p>Crie os potes que organizam as tarefas de {user.residenceName}.</p></div><span>{pots.filter((pot) => pot.isActive).length} ATIVOS</span></div>
