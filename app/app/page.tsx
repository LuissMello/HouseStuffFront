  ...
  return <main className="authenticated-page">
    ...
    <div className="app-shell">
      {residence ? <>
        ...
        <div className="admin-callout-grid"><a className="admin-callout" href="#/app/tasks"><div><small>ROTINA</small><strong>Cadastre as tarefas da casa</strong><p>Escolha o pote, o tipo e o intervalo de recorrência.</p></div><span aria-hidden="true">→</span></a><a className="admin-callout" href="#/app/pots"><div><small>ORGANIZAÇÃO</small><strong>Cadastre e ordene os potes</strong><p>Defina os potes que os moradores verão.</p></div><span aria-hidden="true">→</span></a>{user.isAdministrator && <a className="admin-callout" href="#/admin/users"><div><small>ACESSOS</small><strong>Gerencie as pessoas da casa</strong><p>Crie usuários e associe acessos pendentes.</p></div><span aria-hidden="true">→</span></a>}</div>
