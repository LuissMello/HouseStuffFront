...
export function AuthenticatedHeader({ user }: { user: CurrentUser }) {
  ...
  </header><nav className="mobile-app-nav" aria-label="Navegação móvel"><a href="/app"><span aria-hidden="true">⌂</span>Casa</a><a href="/app/routine"><span aria-hidden="true">◷</span>Rotina</a><a href="/app/pots"><span aria-hidden="true">◉</span>Potes</a><a href="/app/tasks"><span aria-hidden="true">▣</span>Tarefas</a></nav></>;
}
